...
public:
  ...
  bool outputEdge;
  bool intersectPt;
  IntPoint(long64 x = 0, long64 y = 0, bool in = false, bool out = false, bool inter = false): X(x), Y(y), inputEdge(in), outputEdge(out), intersectPt(inter) {};
...
private:
  ...
  double perpendicularDistance(long64 x1, long64 x2, long64 y1, long64 y2, long64 z1, long64 z2);
