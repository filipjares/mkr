...
\note{
	poznámky, které se vygenerují zvlášť:
	\begin{itemize}
		\item pomocné "knihovny"
		\item ORTE
		\item ruzné verze fsmact
		\item případně zmiňovaný "okolní software" zmínit pouze velmi stručně, nezabíhat do detailů
	\end{itemize}
}
...
\section{Název sekce (do obsahu)}
{
% Tenhle slide je zvláštní tím, že má na pozadí jenom tenhle obrázek:
%\setbeamertemplate{background canvas}{\includegraphics[width=\paperwidth,height=\paperheight]{}} 

%\setbeamercolor{structure}{fg=white!30}
%\setbeamercolor{normal text}{fg=white!30}
\begin{frame}[plain] % plain znamena, bez standardniho pozadi, ktere maji ostanti slidy
	\frametitle{Nadpis slidu bez standardniho pozadi}

\note{
	U takoveho slidu se muze dat na pozadi obrazek pres celou stranku.
	\begin{itemize}
		\item vlastnost 1
		\item vlastnost 2
		\item vlastnost 3
